...
export default function SeatSelectionPage() {
  ...
  const handleCheckout = () => {
    ...
    router.push(`/billing?flightId=${flight?.id}&seats=${selectedSeats.length}&totalPrice=${totalPrice}`)
  }
  ...
  return (
    <div className="container position-relative min-vh-100 py-4">
      ...
      <h2 className="text-center mb-4 position-relative">Flight: {flight.id} - {flight.from} to {flight.to}</h2>
